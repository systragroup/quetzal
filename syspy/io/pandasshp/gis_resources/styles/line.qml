...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="1" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="vol">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  ...
  <aliases>
    ...
    <alias field="vol" index="3" name=""/>
    <alias field="length" index="4" name=""/>
    <alias field="type" index="5" name=""/>
    <alias field="route_type" index="6" name=""/>
    <alias field="label" index="7" name=""/>
    <alias field="process" index="8" name=""/>
    <alias field="color" index="9" name=""/>
    <alias field="width" index="10" name=""/>
    <alias field="fontsize" index="11" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="vol"/>
...
def my_form_open(dialog, layer, feature):
  ...
  <previewExpression>COALESCE("Unnamed:_0", '&lt;NULL>')</previewExpression>
