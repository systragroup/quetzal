...
<qgis version="2.18.12" simplifyAlgorithm="0" minimumScale="0" maximumScale="1e+08" simplifyDrawingHints="0" minLabelScale="0" maxLabelScale="1e+08" simplifyDrawingTol="1" readOnly="0" simplifyMaxScale="1" hasScaleBasedVisibilityFlag="0" simplifyLocal="1" scaleBasedLabelVisibilityFlag="0">
  <edittypes>
    ...
    <edittype widgetv2type="TextEdit" name="on">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="off">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    <edittype widgetv2type="TextEdit" name="onoff">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
    ...
    <edittype widgetv2type="TextEdit" name="fontsize">
      <widgetv2config IsMultiline="0" fieldEditable="1" constraint="" UseHtml="0" labelOnTop="0" constraintDescription="" notNull="0"/>
    </edittype>
  </edittypes>
    ...
    <symbols>
      <symbol alpha="1" clip_to_extent="1" type="marker" name="0">
        <layer pass="0" class="SimpleMarker" locked="0">
          ...
          <prop k="size_dd_expression" v="&quot;width&quot;  * 10"/>
  ...
  <customproperties>
    ...
    <property key="labeling/dataDefined/Size" value="1~~0~~~~fontsize"/>
    ...
    <property key="labeling/fieldName" value="round(off, 0)"/>
    ...
    <property key="labeling/xOffset" value="7"/>
  ...
  <aliases>
    <alias field="index" index="0" name=""/>
    <alias field="on" index="1" name=""/>
    <alias field="off" index="2" name=""/>
    <alias field="onoff" index="3" name=""/>
    <alias field="process" index="4" name=""/>
    <alias field="label" index="5" name=""/>
    <alias field="color" index="6" name=""/>
    <alias field="width" index="7" name=""/>
    <alias field="fontsize" index="8" name=""/>
  </aliases>
  ...
  <attributetableconfig actionWidgetStyle="dropDown" sortExpression="" sortOrder="0">
    <columns>
      ...
      <column width="-1" hidden="0" type="field" name="on"/>
      <column width="-1" hidden="0" type="field" name="off"/>
      <column width="-1" hidden="0" type="field" name="process"/>
      <column width="-1" hidden="0" type="field" name="index"/>
      <column width="-1" hidden="0" type="field" name="onoff"/>
      <column width="-1" hidden="0" type="field" name="label"/>
      <column width="-1" hidden="0" type="field" name="fontsize"/>
    </columns>
...
def my_form_open(dialog, layer, feature):
  ...
  <defaults>
    ...
    <default field="on" expression=""/>
    <default field="off" expression=""/>
    <default field="onoff" expression=""/>
    <default field="process" expression=""/>
    <default field="label" expression=""/>
    <default field="color" expression=""/>
    <default field="width" expression=""/>
    <default field="fontsize" expression=""/>
  </defaults>
