...
def html_to_png(html, png, driver=None, delay=5):
    ...
    if you need several maps of the very same location to be saved quickly::
        ...
        # finds the location of the map to plot, passing it as an argument to sysfolium.folium_map_from_edges
        # ensures that all the maps focus on the very same place.
